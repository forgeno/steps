...
const response = {  
	sidewalk: {
	  comments: [{id: 544, text: "testing fox", date: "2018-11-29T01:54:48.495327Z"}],
	  lastImage: {
		id: 2,
		url: TEST_IMAGE,
		date: "2018-11-29T01:54:48.495327Z"
	  },
	  totalImages: 1,
	  totalComments: 1,
	  totalRatings: 1,
...
const getSidewalkImagesMock = RequestMock().onRequestTo(/\/sidewalk\/2\//).respond(response);
